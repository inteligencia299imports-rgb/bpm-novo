...
import { Bike, User, Package, ClipboardCheck, PanelLeftClose, PanelLeftOpen, Award, FileSearch, ShoppingBag, Handshake, ShoppingCart, FileText, Wrench, BarChart3, Sparkles } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange, collapsed, onToggle }) => {
  ...
  const tabs = [
    ...
    { id: 'novidades', label: 'Novidades', icon: Sparkles, roles: ['vendedor', 'gestor'] },
