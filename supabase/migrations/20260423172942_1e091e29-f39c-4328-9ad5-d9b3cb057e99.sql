DROP FUNCTION IF EXISTS public.relatorio_avaliacoes_kpis(timestamp with time zone, timestamp with time zone, text);
...
BEGIN
  ...
  SELECT json_build_object(
    ...
    'entrada_direta',       (SELECT COUNT(*) FROM filtrado_avaliacoes WHERE interesse = 'vender'),
    'troca',                (SELECT COUNT(*) FROM filtrado_avaliacoes WHERE interesse = 'trocar'),
