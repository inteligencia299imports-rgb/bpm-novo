...
import { Bike, ClipboardCheck, Package, Award, FileSearch, ShoppingBag, Handshake, ShoppingCart, FileText, Wrench, BarChart3 } from 'lucide-react';
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-card safe-area-bottom overflow-x-auto">
      <div className="flex items-center h-16 min-w-max px-1">
        ...
        <div className="flex flex-col items-center justify-center min-w-[60px] px-2 h-full text-muted-foreground">
          <NotificationBell />
        </div>
      </div>
    </nav>
