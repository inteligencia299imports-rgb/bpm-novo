...
CREATE OR REPLACE FUNCTION public.relatorio_showroom_sinais(_loja text DEFAULT 'todos', _tipo text DEFAULT 'todos')
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  FOR rec IN
    SELECT
      ...
      COALESCE(e.tipo, 'propria') as tipo,
