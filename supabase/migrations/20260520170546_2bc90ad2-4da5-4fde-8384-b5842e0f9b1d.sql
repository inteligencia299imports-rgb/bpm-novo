...
BEGIN
  -- Ciclos fixos: terminam dia 21 de cada mês (jan..dez do ano atual)
  FOR i IN 1..12 LOOP
    v_cycle_end_date := make_date(v_year, i, 21);
    ...
    -- Apenas ciclos já fechados
    EXIT WHEN v_cycle_end >= v_today;

    -- Entradas do ciclo (22 do mês anterior até 21 do mês atual)
    ...
    -- Estoque no fechamento do ciclo (mesmo cálculo do KPI 'Motos no Estoque')
