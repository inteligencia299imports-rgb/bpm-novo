...
import { Users, Check, CreditCard, TrendingUp, CalendarIcon } from 'lucide-react';
...
import { getPreviousPeriod, getPreviousPeriodIso, splitComparado } from '@/lib/reportComparison';
  ...
  return (
    <div className="space-y-4 w-full max-w-full overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <ChartCard title="Sinais" data={[...chartByVendedor].filter(d => d.sinais > 0).sort((a, b) => b.sinais - a.sinais)} dataKey="sinais" chartH={chartH} fillColor="#7e6d9b" />
...
const ChartCard: React.FC<{ title: string; data: any[]; dataKey: string; chartH?: number; fillColor?: string }> = ({ title, data, dataKey, chartH = 300, fillColor = '#2F6F84' }) => {
  const isMobile = useIsMobile();
